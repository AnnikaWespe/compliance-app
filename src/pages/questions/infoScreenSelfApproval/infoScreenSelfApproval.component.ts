...
@Component({
  selector: 'page-info-screen-self-approval',
  templateUrl: 'infoScreenSelfApproval.component.html'
})
export class InfoScreenSelfApprovalComponent implements AfterViewChecked {
